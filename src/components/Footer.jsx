        ...
        <div className="md:flex md:justify-between md:items-center">
          <div className="mb-8 md:mb-0">
            <a href="/" className="flex items-center">
              <img
                src={footerlogo}
                className="h-14 me-3 rounded-md"
                alt="Three-Eyed Logo"
              />
            </a>
            <p className="text-sm text-gray-400 mt-3 max-w-sm">
              Empowering businesses with digital transformation and marketing
              excellence — let's build a smarter future together.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 text-sm">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/industries" className="hover:text-orange-400">
                    Industries
                  </Link>
                </li>
                <li>
                  <Link to="/getcontact" className="hover:text-orange-400">
                    Contact
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/about/careers" className="hover:text-orange-400">
                    Careers
                  </Link>
                </li>
                <li>
                  <Link to="/portfolio" className="hover:text-orange-400">
                    Portfolio
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <div className="flex flex-col space-y-2">
                ...
                <a
                  href="https://www.facebook.com/threeeyedlimited"
                  target="_blank"
                  rel="noopener noreferrer"
