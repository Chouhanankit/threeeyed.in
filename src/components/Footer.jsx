        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            ...
            <div className="w-auto grid grid-cols-2 gap-8 sm:gap-34 sm:grid-cols-3">
              <div>
                <ul className="mb-6 text-sm text-gray-900 first-letter:uppercase dark:text-white">
                  <li className="mb-2">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="sm:text-[0.8rem] text-[10px] text-gray-500 sm:text-center dark:text-gray-400">
              © 2025{" "}
            ...
            <ul className="text-gray-500 dark:text-gray-400 flex sm:justify-around items-center text-[10px]">
              <li>
                <a href="#" className="hover:underline">
                  Privacy Policy
                </a>
              ...
              <li className="px-2">
                <FaCircle size="0.4rem" color="gray" />
              </li>
              <li>
                <a href="#" className="hover:underline">
                  Terms &amp; Conditions
